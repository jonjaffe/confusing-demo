  ...
  inputs: [
    {
      ...
      helperText: "Vehicle registration number to display in the quote",
    },
    {
      name: "title",
      type: "string",
      ...
      helperText:
        "Main title - use {vehicleReg} to insert the vehicle registration",
    },
    {
      name: "description",
      type: "string",
      ...
      helperText: "Description text shown below the title",
    },
    {
      name: "buttonText",
      type: "string",
    ...
    },
    {
      ...
      type: "boolean",
      defaultValue: true,
      helperText: "Show the motor breakdown icon in the header",
    },
    {
      name: "disabled",
      type: "boolean",
